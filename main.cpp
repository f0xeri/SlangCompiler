...
int main(int argc, char **argv) {
    ...
    else
    {
        ...
        std::string clangCall = mingw64path + "\\bin\\clang " + filenamesString + "-lgc-lib -lglew -lglfw3 -lopengl32 -lkernel32 -luser32 -lgdi32 -lws2_32 -DGLEW_STATIC -o " + mainFilename + ".exe";
